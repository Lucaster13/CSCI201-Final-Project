...
/* 
* Code originally written by Lokesh Gupta
...
public class Hash {
	...
	private static String generateHash(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
	    // iterations can be increased to protect against brute force attacks
		int iterations = 1000;
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException {
		 String  originalPassword = "password";
	        String generatedSecuredPasswordHash = generateHash(originalPassword);
