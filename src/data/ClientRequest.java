...
public class ClientRequest implements Serializable {
	...
	public static final int TYPE_REMOVE_PASSWORD = 3;
	public static final int TYPE_RETRIEVE_QUESTIONS = 4;
	public static final int TYPE_ADD_QUESTION = 5;
	public static final int TYPE_EDIT_QUESTION = 6;
	public static final int TYPE_REMOVE_QUESTION = 7;
	public static final int TYPE_DELETE_ACCOUNT = 8;
